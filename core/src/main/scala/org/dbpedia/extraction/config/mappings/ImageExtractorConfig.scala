...
object ImageExtractorConfig
{
    ...
    val NonFreeRegex = Map(
           ...
           "ja" -> """(?iu)\{\{\s?(Non free|Copyright by Wikimedia|Copyvio|Logo|Screenshot|PD-CAGov|Fair use|Noncommercial|PolandGov|Nonderivative|NZCrownCopyright|PD-IndiaGov|ADRM2)\s?\}\}""".r,
