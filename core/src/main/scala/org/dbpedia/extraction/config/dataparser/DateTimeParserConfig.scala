...
object DateTimeParserConfig
{
    ...
    val templateDateMap = Map(
        ...
        "ja" -> Map(
            ...
            "死亡年月日と没年齢"    -> Map ("year" -> "1", "month"-> "2", "day" -> "3"),
            "死亡年月日と没馬齢"    -> Map ("year" -> "2", "month"-> "3", "day" -> "4"),
            "没年齢"                -> Map ("year" -> "1", "month"-> "2", "day" -> "3"),
            "没年齢2"               -> Map ("year" -> "1", "month"-> "2", "day" -> "3"),
